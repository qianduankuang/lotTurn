  ...
  <div class="title t-bg">
    ...
    <wrap bottom="80" top="120" ref="wrap" :scb="scb">
      <ul class="d-wrap" ref="dWrap">
        <li v-for="(v, i) in selectData" :key="v + i">
          <p>
            <input
              placeholder="请输入选项"
              v-model="v.name"
    ...
    <alert
      ...
      :text="alertText"
      :handelClick="isShowCancelAlert ? comfirmAlert : closeAlert"
      :handelClick2="closeAlert"
      :isShowCancelAlert="isShowCancelAlert"
    ></alert>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    comfirmAlert() {
      this.selectData.splice(this.delindex, 1);
